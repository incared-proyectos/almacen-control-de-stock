	...
	export default {
	    ...
	    methods:{
	    	createdCellStock(cell,cellData,rowData){
	    		let me = this;
	          	$(cell).empty();
	            let actions = Vue.extend(require('@/pages/Productos/Inputs_datatables/InputStock.vue').default);
	    	...
	    	createdCellStockActual(cell,cellData,rowData){
	    		let me = this;
	          	$(cell).empty();
	            let actions = Vue.extend(require('@/pages/Productos/Inputs_datatables/InputStockActual.vue').default);
	            let store = this.$store;
	            let instance = new actions({
	            	store,
	                propsData: rowData
